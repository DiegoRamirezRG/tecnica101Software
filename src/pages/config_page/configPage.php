            ...
            <div class="col-12 col-md-7 d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="row w-100 mt-1 mt-md-5">
                    ...
                    <div class="col-12 col-sm-6">
                        <label for="updateProfileName">Actualizar Apellido Paterno</label>
                        <div class="input-group mb-3">
                ...
                <div class="row w-100 mt-2">
                    <div class="col">
                        <label for="updateProfileName">Actualizar Apellido Materno</label>
                        <div class="input-group mb-3">
                    ...
                    <div class="col-12 col-sm-6">
                        <label for="updateProfileName">Actualizar Teléfono</label>
                        <div class="input-group mb-3">
